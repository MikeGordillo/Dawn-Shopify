...
//        jQuery(".is-active").show();
      ...
      if (prepend) {
        jQuery(jQuery(".current_tmb").get().reverse()).each(function() {activeMedia.parentElement.prepend(this)});
      ...
      window.setTimeout(() => {
        ...
        if (!this.elements.thumbnails || this.dataset.desktopLayout === 'stacked') {
          // REMOVES STICKY HEADER THAT REFOCUSES PAGE ONCLICK VARIANT - JVL
...
function chkval(optn,n,defaultcolor){ 
  ...
  if(optn.replace('_', ' ') === defaultcolor){
//     alert(defaultcolor); 
